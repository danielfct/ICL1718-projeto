...
public class ASTLesserEq extends ASTNode {

	final IASTNode left, right;
	private IType type;

	public ASTLesserEq(IASTNode left, IASTNode right) {
		this.left = left;
		this.right = right;
		this.type = null;
	}
	...
	public void compile(ICodeBuilder code, ICompilationEnvironment env) throws DuplicateIdentifierException, UndeclaredIdentifierException {
		String labelLesserEq = "label" + IdFactory.singleton.label();
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof ASTLesserEq))
			return false;
		ASTLesserEq other = (ASTLesserEq) obj;
